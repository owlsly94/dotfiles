...
## Osnovne aplikacije
- **ALT + Enter** – Otvara podrazumevani terminal
- **SUPER + B** – Otvara sekundarni browser
- **SUPER + T** – Otvara Thorium browser
- **SUPER + C** – Otvara VS Code
- **ALT + D** – Otvara fajl menadžer (pcmanfm)
...
- **SUPER + 1** – Prikazuje ili skriva terminal scratchpad
